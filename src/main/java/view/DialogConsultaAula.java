 ...
 * @author Gustavo
 */
public class DialogConsultaAula extends javax.swing.JDialog {

    /**
     * Creates new form DialogConsultaAula
     */
    public DialogConsultaAula(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    AulaTableModel aulaTable = new AulaTableModel();
    ...
    private void initComponents() {
        ...
        jComboBoxPesquisaItens.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Id", "Nome" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jComboBoxPesquisaItens, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTableAulas.setModel(aulaTable);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        } else if (jComboBoxPesquisaItens.getSelectedIndex() == 1 && apenasNumeros == false) {
            JOptionPane.showMessageDialog(this, "Erro ao pesquisar, utilize APENAS NÚMEROS!");

        } else {
            try {
                List<Aulas> lista = gerInter.getInstance().getGerDom().pesquisarAulas(jTextFieldPesquisa.getText(), jComboBoxPesquisaItens.getSelectedIndex());
                aulaTable.setList(lista);
    ...
    private void jButtonSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSairActionPerformed
        ...
        aulaTable.limparValoresDasCelulas();
    ...
    private void jButtonGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGerarRelatorioActionPerformed
        ...
        List lista = aulaTable.getLista();
        gerInter.getInstance().getGerRel().relComLista(lista, "relAulas.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogConsultaAula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogConsultaAula dialog = new DialogConsultaAula(new javax.swing.JFrame(), true);
