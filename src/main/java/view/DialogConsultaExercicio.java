 ...
 * @author Gustavo
 */
public class DialogConsultaExercicio extends javax.swing.JDialog {

    /**
     * Creates new form DialogConsultaExercicio
     */
    public DialogConsultaExercicio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    ExercicioTableModel ex = new ExercicioTableModel();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("CONSULTA EXERCICIO");
        ...
        jComboBoxPesquisaItens.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " ", "Id", "Nome", "Função", "Série" }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jComboBoxPesquisaItens, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, 598, Short.MAX_VALUE)
                    .addContainerGap()))
        );
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        } else if ((jComboBoxPesquisaItens.getSelectedIndex() == 1 ||jComboBoxPesquisaItens.getSelectedIndex() ==  4)&& apenasNumeros == false) {
            JOptionPane.showMessageDialog(this, "Erro ao pesquisar, utilize APENAS NÚMEROS!");

        } else {
            try {
                List<Exercicio> lista = gerInter.getInstance().getGerDom().pesquisarExercicio(jTextFieldPesquisa.getText(), jComboBoxPesquisaItens.getSelectedIndex());
                ex.setList(lista);
            } catch (HibernateException | NumberFormatException ex) {
                JOptionPane.showMessageDialog(this,"O ID pesquisado não está cadastrado", "ERRO", JOptionPane.ERROR_MESSAGE);
//                JOptionPane.showMessageDialog(this, ex.getMessage(), "ERRO pesquisar", JOptionPane.ERROR_MESSAGE);
    ...
    private void jButtonGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGerarRelatorioActionPerformed
        // Passar a lista de PEDIDOS para o RELATÓRIO
        
        List lista = ex.getLista();

        
        gerInter.getGerRel().relComLista(lista, "relExercicios.jasper");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogConsultaExercicio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogConsultaExercicio dialog = new DialogConsultaExercicio(new javax.swing.JFrame(), true);
